---
description: Comandos de menú y otras teclas de acceso directo (SybaseToSQL)
title: Comandos de menú y otras teclas de método abreviado (Sybase a SQL) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
ms.reviewer: ''
...
|Muestra el cuadro de diálogo conectar o volver a conectar con Sybase.|ALT + F + T|  
...
## <a name="edit-menu-commands"></a>Editar comandos de menú  
...
## <a name="tester-menu-commands"></a>Comandos de menú de evaluador  
Para obtener acceso al menú de prueba, el método abreviado de teclado utilizado es ALT + S. En la tabla siguiente se describen los métodos abreviados de teclado que se usan para tener acceso a los elementos de menú en el menú evaluador.  
  
|PARA ELLO|Pulse|  
|--------------|---------|  
|Muestra el cuadro de diálogo Asistente para casos de prueba.|ALT + S + N|  
|Muestra el cuadro de diálogo repositorio de casos de prueba.|ALT+S+C|  
|Mostrar el repositorio del cuadro de diálogo resultados de pruebas.|ALT + S + R|  
|Acceda al submenú de administración de copia de seguridad de Sybase.|ALT + S + B|  
|Muestre el cuadro de diálogo Agregar tablas a la copia de seguridad de Sybase.|ALT + S + B + B|  
|Muestre el cuadro de diálogo restaurar tablas de copia de seguridad para Sybase.|ALT + S + B + R|  
|Muestra el cuadro de diálogo administrar contenido de copia de seguridad para Sybase.|ALT + S + B + C|  
|Acceso SQL Server submenú de administración de copia de seguridad.|ALT+S+M|  
|Muestre agregar tablas a la copia de seguridad para SQL Server cuadro de diálogo.|ALT + S + M + B|  
...
|PARA ELLO|Pulse|  
|--------------|---------|  
|Mostrar acerca de SSMA para el cuadro de diálogo de Sybase.|ALT + H + A|  
...
[Teclas de método abreviado&#40;Sybase a SQL&#41;](../../ssma/sybase/shortcut-keys-sybase-to-sql.md)  
