---
description: Creación de archivos de conexión del servidor (OracleToSQL)
title: Crear los archivos de conexión del servidor (OracleToSQL) | Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
El siguiente paso en el funcionamiento de la consola es la [ejecución de la consola de SSMA &#40;OracleToSQL&#41;](../../ssma/oracle/executing-the-ssma-console-oracletosql.md)  
