---
description: Nuevas características de la interfaz gráfica de usuario de SSMA para DB2 (DB2ToSQL)
title: Nuevas características de la interfaz gráfica de usuario de SSMA para DB2 (DB2ToSQL) | Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
