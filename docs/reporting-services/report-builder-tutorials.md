...
description: Obtenga información sobre cómo crear informes paginados básicos de SQL Server Reporting Services (SSRS), incluidas las formas de conectarse a orígenes de datos y agregar gráficos a los informes.
ms.date: 05/30/2017
