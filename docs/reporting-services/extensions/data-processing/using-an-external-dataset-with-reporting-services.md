...
description: Cree extensiones de procesamiento de datos personalizadas en Reporting Services para poder integrar objetos DataSet personalizados creados mediante aplicaciones externas.
ms.date: 03/06/2017
