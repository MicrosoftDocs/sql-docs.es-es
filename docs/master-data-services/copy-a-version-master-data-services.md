---
description: Copiar una versión (Master Data Services)
...
2.  En la página **Administrar versiones** , seleccione la fila de la versión que desea copiar.  
    ...
    > [!NOTE]  
    >  Según el valor de una opción de [!INCLUDE[ssMDScfgmgr](../includes/ssmdscfgmgr-md.md)], es posible que pueda copiar únicamente las versiones con el estado **Confirmado** . Para obtener más información, vea [Configuración del sistema &#40;Master Data Services&#41;](../master-data-services/system-settings-master-data-services.md).  
