---
description: Cambiar el nombre de una jerarquía derivada (Master Data Services)
title: Cambiar el nombre de una jerarquía derivada
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.prod_service: mds
...
6.  En la página **Editar jerarquía derivada** , haga clic en el icono de lápiz que está junto al nombre de jerarquía derivada.  
