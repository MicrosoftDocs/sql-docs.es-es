...
## <a name="remarks"></a>Observaciones  
 El método storesUpperCaseQuotedIdentifiers especifica este método storesUpperCaseQuotedIdentifiers en la interfaz java.sql.DatabaseMetaData.  
