---
description: Método getDatabaseProductVersion (SQLServerDatabaseMetaData)
...
## <a name="return-value"></a>Valor devuelto  
 Un objeto **String** que contiene el número de versión del producto de base de datos.  
  
## <a name="exceptions"></a>Excepciones  
 [SQLServerException](../../../connect/jdbc/reference/sqlserverexception-class.md)  
  
## <a name="remarks"></a>Observaciones  
 El método getDatabaseProductVersion especifica este método getDatabaseProductVersion en la interfaz java.sql.DatabaseMetaData.  
