 ...
 *m*  
 ...
 Valor **int** que indica el número de dígitos a la derecha del signo decimal. Este parámetro se omite para todos los tipos salvo para NUMERIC y DECIMAL.  
