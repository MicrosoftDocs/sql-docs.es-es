...
description: Obtenga información sobre cómo crear una plantilla a partir de un seguimiento existente en SQL Server Profiler mientras se ejecuta el seguimiento.
ms.prod: sql
