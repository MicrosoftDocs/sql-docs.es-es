---
title: Informe de implementación e informe de desfase de SqlPackage
description: Obtenga información sobre cómo automatizar las tareas de desarrollo de bases de datos con el informe de implementación y el de desfase de SqlPackage.exe. Vea ejemplos y los parámetros, las propiedades y las variables SQLCMD disponibles.
ms.prod: sql
...
La acción [DriftReport](#driftreport-action-parameters) de SqlPackage.exe crea un informe XML de los cambios que se han realizado en la base de datos registrada desde que registró por última vez.  
...
## <a name="deployreport-action-parameters"></a>Parámetros de la acción DeployReport
...
## <a name="deployreport-action-properties"></a>Propiedades de la acción DeployReport
...
## <a name="driftreport-action-parameters"></a>Parámetros de la acción DriftReport
