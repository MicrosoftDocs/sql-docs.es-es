---
title: Propiedades de NS$&lt;nombre de servicio&gt; (pestaña Servicio)
description: Obtenga información sobre las opciones de la pestaña Servicio del cuadro de diálogo Propiedades de Notification Services, como la ruta de acceso binaria, el nombre de host y el modo de inicio.
