...
description: En este artículo se proporcionan vínculos a información para instalar características de SQL Server que forman parte de la plataforma de inteligencia empresarial de Microsoft.
...
-   [Instalar Analysis Services](/analysis-services/instances/install-windows/install-analysis-services)  
  
-   [Instalación de Analysis Services en el modo PowerPivot](/analysis-services/instances/install-windows/install-analysis-services-in-power-pivot-mode)  
...
> [!NOTE]
> SQL Server Data Tools (SSDT) no se incluye con SQL Server 2016. [Descargar SQL Server Data Tools](../../ssdt/download-sql-server-data-tools-ssdt.md).
...
## <a name="see-also"></a>Consulte también  
 ...
 [Actualización a SQL Server](../../database-engine/install-windows/upgrade-sql-server.md)  
