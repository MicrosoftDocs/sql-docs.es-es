...
description: Listas de asociados externos que cuentan con soluciones para supervisar los servicios SQL Server.
ms.topic: conceptual
ms.custom: ''
ms.date: 11/02/2017
ms.prod: sql
