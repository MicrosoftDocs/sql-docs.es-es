...
description: Listas de asociados externos con soluciones para proporciona alta disponibilidad y recuperación ante desastres de los servicios de SQL Server.
ms.topic: conceptual
