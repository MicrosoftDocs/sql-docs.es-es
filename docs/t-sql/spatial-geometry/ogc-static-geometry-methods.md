---
description: Métodos de geometría estáticos de OGC
...
ms.locfileid: "99237856"
---
# <a name="ogc-static-geometry-methods"></a>Métodos de geometría estáticos de OGC
[!INCLUDE [SQL Server Azure SQL Database ](../../includes/applies-to-version/sql-asdb.md)]

  [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)] admite los métodos de geometría estáticos de Open Geospatial Consortium (OGC).  
