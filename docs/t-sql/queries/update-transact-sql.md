...
ms.locfileid: "100353601"
---
# <a name="update-transact-sql"></a>UPDATE (Transact-SQL)
[!INCLUDE [sql-asdb-asdbmi-asa-pdw](../../includes/applies-to-version/sql-asdb-asdbmi-asa-pdw.md)]

  Cambia los datos de una tabla o vista de [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)]. Para obtener ejemplos, vea [Ejemplos](#UpdateExamples).  
 ...
 *rowset_function_limited*  
 ...
 Especifica una o varias sugerencias de tabla que están permitidas en una tabla de destino. La palabra clave WITH y los paréntesis son obligatorios. No se permiten NOLOCK, READUNCOMMITTED ni NOEXPAND. Para información sobre las sugerencias de tabla, vea [Sugerencias de tabla &#40;Transact-SQL&#41;](../../t-sql/queries/hints-transact-sql-table.md).  
