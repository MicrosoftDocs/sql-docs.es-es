---
description: '&amp;= (Asignación de AND bit a bit) (Transact-SQL)'
title: '&amp;= (Asignación de AND bit a bit) (Transact-SQL) | Microsoft Docs'
ms.custom: ''
ms.date: 01/10/2017
ms.prod: sql
...
ms.openlocfilehash: 2bda5cd4334cf652f5beab5906741729cca755d3
ms.sourcegitcommit: 33f0f190f962059826e002be165a2bef4f9e350c
ms.translationtype: HT
ms.contentlocale: es-ES
ms.lasthandoff: 01/30/2021
ms.locfileid: "99197817"
---
# <a name="amp-bitwise-and-assignment-transact-sql"></a>&amp;= (Asignación de AND bit a bit) (Transact-SQL)
