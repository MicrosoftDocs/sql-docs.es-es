---
description: GRANT (permisos de clave simétrica de Transact-SQL)
title: GRANT (permisos de clave simétrica de Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 08/10/2017
ms.prod: sql
