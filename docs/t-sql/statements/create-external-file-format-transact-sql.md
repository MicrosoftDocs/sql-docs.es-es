...
```  
### <a name="e-create-a-delimited-text-file-skipping-header-row-azure-synapse-analytics-only"></a>E. Crear un archivo de texto delimitado y omitir la fila de encabezado (solo Azure Synapse Analytics)
