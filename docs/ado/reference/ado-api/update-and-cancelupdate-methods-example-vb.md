---
description: Ejemplo de los métodos Update y CancelUpdate (VB)
...
```  
 ...
 En este ejemplo se muestra el método **Update** junto con el método [AddNew](./addnew-method-ado.md) .  
