---
description: Ejemplo del método Resync (VB)
title: Ejemplo del método Resync (VB) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "100051616"
---
# <a name="resync-method-example-vb"></a>Ejemplo del método Resync (VB)
