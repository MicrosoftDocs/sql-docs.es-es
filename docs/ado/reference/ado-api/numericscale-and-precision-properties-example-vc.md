---
description: Ejemplo de las propiedades NumericScale y Precision (VC ++)
title: Ejemplo de las propiedades NumericScale y Precision (VC + +) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "100041516"
---
# <a name="numericscale-and-precision-properties-example-vc"></a>Ejemplo de las propiedades NumericScale y Precision (VC ++)
En este ejemplo se usan las propiedades [NumericScale](./numericscale-property-ado.md) y [Precision](./precision-property-ado.md) para mostrar la escala numérica y la precisión de los campos en la tabla ***descuentos** _ de la base de datos _ *_pubs_**.  
