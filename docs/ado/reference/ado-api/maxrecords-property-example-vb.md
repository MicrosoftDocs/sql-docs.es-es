---
description: Ejemplo de la propiedad MaxRecords (VB)
title: Ejemplo de la propiedad MaxRecords (VB) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "100044005"
---
# <a name="maxrecords-property-example-vb"></a>Ejemplo de la propiedad MaxRecords (VB)
En este ejemplo se usa la propiedad [MaxRecords](./maxrecords-property-ado.md) para abrir un [conjunto de registros](./recordset-object-ado.md) que contiene los 10 títulos más caros en la tabla ***titles*** .  
