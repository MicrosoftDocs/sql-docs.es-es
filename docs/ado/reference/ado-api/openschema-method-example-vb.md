...
```  
 ...
 En este ejemplo se especifica una TABLE_TYPE restricción de consulta en el argumento de criterios del método **OpenSchema** ***_. Como resultado, solo se devuelven la información de esquema de las vistas especificadas en la base de datos _*_pubs_** . A continuación, en el ejemplo se muestran los nombres y los tipos de cada tabla (s).  
