---
description: Ejemplo de la propiedad MaxRecords (VC ++)
...
ms.locfileid: "99170849"
---
# <a name="maxrecords-property-example-vc"></a>Ejemplo de la propiedad MaxRecords (VC ++)
En este ejemplo se usa la propiedad [MaxRecords](./maxrecords-property-ado.md) para abrir un [conjunto de registros](./recordset-object-ado.md) que contiene los 10 títulos más caros en la tabla ***titles** _.  
