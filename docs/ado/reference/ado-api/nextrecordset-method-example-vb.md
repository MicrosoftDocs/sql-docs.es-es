---
description: Ejemplo del método NextRecordset (VB)
title: Ejemplo del método NextRecordset (VB) | Microsoft Docs
ms.prod: sql
...
## <a name="see-also"></a>Consulte también  
 [NextRecordset (método) (ADO)](./nextrecordset-method-ado.md)   
