---
description: Ejemplo de propiedades AbsolutePage, PageCount y PageSize (VC + +)
title: Ejemplo de propiedades AbsolutePage, PageCount y PageSize (VC + +) | Microsoft Docs
ms.prod: sql
