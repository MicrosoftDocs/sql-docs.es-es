---
description: Eventos, métodos y propiedades de la colección de índices
title: Propiedades, métodos y eventos de la colección de índices | Microsoft Docs
ms.prod: sql
