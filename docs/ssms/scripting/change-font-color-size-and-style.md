...
description: Aprenda a cambiar el color, el tamaño y el estilo de la fuente para los editores de SQL Server Management Studio. El color puede ser diferente para los distintos tipos de texto (como comentarios e instrucciones).
