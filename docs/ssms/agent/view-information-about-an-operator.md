---
description: Ver información acerca de un operador
title: Ver información acerca de un operador
...
Para más información, consulte [sp_help_operator (Transact-SQL)](../../relational-databases/system-stored-procedures/sp-help-operator-transact-sql.md).  
