...
Para configurar Apache Spark y Apache Hadoop en clústeres de macrodatos, debe modificar el perfil de clúster (bdc.json) en el momento de la implementación.

## <a name="supported-configurations"></a>Configuraciones admitidas
Los clústeres de macrodatos emplean los mismos valores de configuración predeterminados que el proyecto de código abierto respectivo.
...
> [!NOTE]
> Hay algunas opciones de configuración en las que se ha cambiado el valor predeterminado. En el siguiente código JSON se enumeran estas opciones y sus valores predeterminados. Sin embargo, estas opciones se pueden cambiar. Si hay opciones que no aparecen en la lista del código JSON, consulte los vínculos anteriores.
...
###  <a name="big-data-clusters-specific-default-configurations"></a>Configuraciones predeterminadas específicas de clústeres de macrodatos
Las configuraciones mostradas en el archivo JSON son las predeterminadas específicas de BDC. En caso necesario, se pueden modificar en el momento de la implementación. Aparecen aquí puesto que son diferentes de sus respectivas configuraciones predeterminadas del proyecto.
