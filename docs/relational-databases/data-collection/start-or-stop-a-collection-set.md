---
description: Iniciar o detener un conjunto de recopilación
...
ms.locfileid: "99250158"
---
# <a name="start-or-stop-a-collection-set"></a>Iniciar o detener un conjunto de recopilación
 [!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]
  En este tema se describe cómo iniciar o detener un conjunto de recopilación en [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)] mediante [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] o [!INCLUDE[tsql](../../includes/tsql-md.md)].  
