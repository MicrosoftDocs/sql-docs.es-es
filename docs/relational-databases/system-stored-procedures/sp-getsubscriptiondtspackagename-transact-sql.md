...
`[ @publication = ] 'publication'` Es el nombre de la publicación. **'**_Publication_*_'_* es de **tipo sysname** y no tiene ningún valor predeterminado.  
