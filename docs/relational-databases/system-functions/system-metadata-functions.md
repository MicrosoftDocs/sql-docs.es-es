---
description: Funciones de metadatos del sistema
title: Funciones de metadatos del sistema | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "99208047"
---
# <a name="system-metadata-functions"></a>Funciones de metadatos del sistema
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] proporciona las siguientes funciones de metadatos.  
