---
description: Vistas de administración dinámica relacionadas con la base de datos (Transact-SQL)
title: Vistas de administración dinámica relacionadas con bases de datos (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 05/18/2017
ms.prod: sql
ms.reviewer: ''
...
La DMV es única para SQL Database o Azure Synapse Analytics.   
