...
##  <a name="sssql16-md-and-later"></a><a name="bkmk_2016"></a> [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] y versiones posteriores  
 En la tabla siguiente se describen las columnas de `sys.dm_db_xtp_checkpoint_files` , a partir de **[!INCLUDE[sssql16-md](../../includes/sssql16-md.md)]** .  
