---
description: Funciones y vistas de administración dinámica relacionadas con la seguridad (Transact-SQL)
title: Security-Related funciones y vistas de administración dinámica (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/20/2017
ms.prod: sql
ms.reviewer: ''
