...
|**socket_count** |**int** | **Se aplica a:** [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] SP2 y versiones posteriores<br /><br />Especifica el número de sockets de procesador disponibles en el sistema. |  
|**cores_per_socket** |**int** | **Se aplica a:** [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] SP2 y versiones posteriores<br /><br />Especifica el número de procesadores por socket disponibles en el sistema. |  
|**numa_node_count** |**int** | **Se aplica a:** [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] SP2 y versiones posteriores<br /><br />Especifica el número de nodos Numa disponibles en el sistema. Esta columna incluye los nodos Numa físicos y los nodos Numa de software. |  
